module unreal::unreal_token {
    ...
    const INITIAL_SUPPLY: u64 = 250000000000000000000000000; // 250M with 18 decimals
    ...
    struct UnrealTokenCapabilities has key {
        mint_cap: MintCapability<UnrealToken>,
        burn_cap: BurnCapability<UnrealToken>,
        freeze_cap: FreezeCapability<UnrealToken>,
    }
    ...
    public entry fun burn(
        ...
        let admin_addr = signer::address_of(admin);
        let caps = borrow_global<UnrealTokenCapabilities>(@unreal);
        let coins_to_burn = coin::withdraw<UnrealToken>(admin, admin_addr, amount);
